...
var eventDropdown = $('#event-dropdown');
var notificationBar = $('#notification');
var hackpointsPopup = $('#hackpoints-notification');
var pointValText = $('#point-value');
...
function airtableReq(airtableURL, reqMethod, onCompletionFunc) {
    $.ajax({
        url: airtableURL,
        method: reqMethod,
    })
    .done(onCompletionFunc);    
}
